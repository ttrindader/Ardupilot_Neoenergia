...
#include "AC_AttitudeControl_River.h" // Attitude control library
...
class AC_PosControlRiver
{
public:

    /// Constructor
    AC_PosControlRiver(AP_AHRS_View& ahrs, const AP_InertialNav& inav,
...
protected:
    ...
    AC_AttitudeControl_River&         _attitude_control;
