...
AP_GPS_GAZEBO::AP_GPS_GAZEBO(AP_GPS &_gps, AP_GPS::GPS_State &_state, AP_HAL::UARTDriver *_port) :
...
void AP_GPS_GAZEBO::handle_msg(const mavlink_message_t &msg)
{
    ...
    if(GAZEBO_MESSAGE_ENABLED){
       ...
       packet.speed_accuracy = 1; //TODO: EXPLORE GAZEBO PLUGIN
       //packet.horizontal_accuracy = 1; //TODO: EXPLORE GAZEBO PLUGIN
       //packet.vertical_accuracy = 1; //TODO: EXPLORE GAZEBO PLUGIN
       //state.gps_yaw = wrap_360(packet.yaw*0.01); //TODO: EXPLORE GAZEBO PLUGIN
       /*      
       ...
       //packet.status = (AP_GPS::GPS_Status)3; //TODO: EXPLORE GAZEBO PLUGIN
       //packet.num_sats = 13; //TODO: EXPLORE GAZEBO PLUGIN
       //packet.last_gps_time_ms = AP_HAL::millis(); //TODO: EXPLORE GAZEBO PLUGIN        
       ...
       state.speed_accuracy = 1; //TODO: EXPLORE GAZEBO PLUGIN
       state.horizontal_accuracy = 1; //TODO: EXPLORE GAZEBO PLUGIN
       state.vertical_accuracy = 1; //TODO: EXPLORE GAZEBO PLUGIN
       //state.gps_yaw = wrap_360(packet.yaw*0.01); //TODO: EXPLORE GAZEBO PLUGIN
       /*      
       if (packet.fix_type >= 3 && packet.time_week > 0) { */
       ...
       state.last_gps_time_ms = AP_HAL::millis(); //TODO: EXPLORE GAZEBO PLUGIN
       _new_data = true; //TODO: EXPLORE GAZEBO PLUGIN
